...
// thumbs buttons; after voting, a result sheet slides up with the live
// split and a link through to the full debate page (comments live there).
export default function VoteCard({ post, onAdvance }) {
  ...
  return (
    <div className="relative">
      <div
        ...
        className="relative rounded-card overflow-hidden shadow-card select-none"
        style={{ touchAction: "none", background: "var(--neutral-mid)", aspectRatio: "3 / 4", cursor: revealed ? "default" : "grab" }}
      >
      ...
      <div className="flex items-center justify-center gap-4 mt-4">
        ...
        <Link
          href={debateUrl}
          className="w-11 h-11 rounded-full flex items-center justify-center text-base shadow-card"
        ...
        <>
          ...
          >
            ...
            <h3 className="text-base font-bold mb-3">
              {vote.direction === "up" ? t.youSaidUp : t.youSaidDown} — {t.viewDebate.replace(" →", "")}
            </h3>
